...
HD_PWD='C:/Users/Dev Account/Documents/gbaHD/gbaHD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log topUnit4x.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source topUnit4x.tcl
