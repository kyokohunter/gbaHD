...
HD_PWD='C:/Users/Dev Account/Documents/gbaHD/gbaHD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log topUnit4x.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source topUnit4x.tcl -notrace
